<template>
  <div>
    ...
    <portal v-if="show" to="external" :targetEl="targetEl">
      This content will be portal'ed to an element outside of this Vue app, with the help of the <i>targetEl</i> prop.
    </portal>
  </div>
</template>
