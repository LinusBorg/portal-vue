...
import ScopedSlots from './components/scoped-slots'
...
import instancePersistence from './components/test-instance-persistence'
...
const routes = [
  ...
  {
    path: '/instancePersistence',
    component: instancePersistence,
  },
  {
    path: '/propstotarget',
